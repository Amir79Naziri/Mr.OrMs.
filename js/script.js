...
// }
//
// async function save_name_on_storage(name, gender) {
//
...
// }
//
// async function remove_name_from_storage(name) {
//     if (name != null) {
...
//         remove_name_from_storage(last_name_from_storage).then(free_save_card)
//     }
// }
//
...
async function submit_clicked() {
    let response = await fetch("https://api.genderize.io/?name=hassan");
